...
in {
  ...
  accounts.email.accounts."cass@mountclare.net".primary = true;
    ...
    services = {
      ...
      llama-cpp-proxy = {
        ...
        Service = {
          ...
          ExecStart = "/run/current-system/systemd/lib/systemd/systemd-socket-proxyd 127.0.0.1:8002 --exit-idle-time=60min";
          TimeoutStartSec = "30s";
        };
      };
    };
